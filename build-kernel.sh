...
# Kernel info
KERNEL_VERSION="" # Enter kernel version here
KERNEL_NAME="" # Enter the name of your kernel here
KERNEL_DEVICE="" # Enter device code name here. eg: bacon for OnePlus One
KERNEL_DEFCONFIG="" # Enter defconfig file name 

# Device Spceifics
export ARCH=arm
export CROSS_COMPILE="" # Enter path to arm-linux-androideabi- 
export KBUILD_BUILD_USER="" #Enter username here
export KBUILD_BUILD_HOST="" #Enter host name here
...
cd $OUT_DIR
zip -r $KERNEL_NAME-$KERNEL_DEVICE-$KERNEL_VERSION-$(date +"%Y%m%d")-$(date +"%H%M%S").zip *
